...
//        User user1 = new User("Huy","Xuan",Staticstuffs.ConvertStringtoDate("07-08-2004"),"admin","nam","1111111111","lmao420@gmail.com",null);
//        UserDao userDao1 = new UserDao(this.getApplicationContext());
//        userDao1.addUser(user1);
//
//        Product product1 = new Product("giày nike",30,"38.5","yellow","nam",1000000,"nike","giày xịn xò blah blah blah",null);

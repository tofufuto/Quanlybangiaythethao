...
public class CustomerOrderAdapter extends BaseAdapter {
    ...
    public CustomerOrderAdapter(Context context,ArrayList<UserOrder> userOrders,LayoutInflater inflater){
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        view = inflater.inflate(R.layout.order_layout_customer,null);
